...
import io.github.dps0340.paramstoquerydslexample.service.CompanyService;
...
public class CompanyController {
    ...
    List<Company> getCars(@QuerydslPredicate Predicate predicate) {
        return companyService.getCarsByPredicate(predicate);
    }
}